...
#define SCHOOLNAME  "ST實驗室"   /* 組織名稱 */
#define BBSNAME   "拉帕之結"    /* 中文站名 */
#define BBSNAME2  "STRoom.LaPa.BBS" /* 英文站名 */
#define SYSOPNICK "拉帕先生"    /* sysop 的暱稱 */
...
#define BBSHOME		"/home/lapa/bbs"		/* BBS 的家 */
#define BAKPATH		"/home/lapa/bbs/bak"		/* 備份檔的路徑 */
...
#define MODE_STAT               /* 觀察及統計 user 的生態，以做為經營方針 */
...
#define SYSOP_SU    /* itoc.001102: 以 sysop 登入可以變更使用者身分 */
...
#undef  TIME_KICKER   /* itoc.030514: 是否自動簽退 idle 過久的使用者 */
...
#define RANDOM_BANNER           /* 041112.Lacool:新增亂數取 banner 中的符號 */
...
#define HAVE_POSTLAW    /* wake.080606: 發表文章時顯示綱領 */

#define POST_PREFIX   /* itoc.020113: 發表文章時標題可選擇種類 */

#define PREFIX_EDIT   /* wake.080606: 發表文章種類可自訂 */
...
#define MAX_BOTTOM    5   /* 置底文章最大數量 */ /* wakefield.081212: 修改為另一種置底結構 */
...
#define MULTI_MAX 3   /* 一般使用者最大 multi-login 個數 */
