...
/* 基本顏色定義，以利介面修改				 */
/* ----------------------------------------------------- */
/* 040423.Lacool:修改前段顏色、後段顏色、光棒玵色、標題顏色、內容顏色、作者線上顏色 */
#define COLOR1		"\033[;31;47m"	/* footer/feeter 的前段顏色 */
#define COLOR2		"\033[1;37;43m"	/* footer/feeter 的後段顏色 */
...
#define COLOR7		"\033[1;37m"	/* 作者在線上的顏色 */
...
/* 040423.Lacool:修改未讀標示、不轉信標示、轉信標示 */
#define VMSG_NULL	"                           \033[1;36;44m   請按任意鍵繼續   \033[m"

#define ICON_UNREAD_BRD		"\033[1;32m‧\33[m"	/* 未讀看板 */
...
#define ICON_TRAN_BRD		"\033[1;36m +\33[m"		/* 轉信板 */
